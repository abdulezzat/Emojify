...
public class Emojiflier {
    final static String LOG_TAG = Emojiflier.class.getSimpleName();
    private static final double SMILING_PROB_THRESHOLD = .15;
    private static final double EYE_OPEN_PROB_THRESHOLD = .5;
    private static final float EMOJI_SCALE_FACTOR = .9f;


    static public Bitmap detectFacesAndOverlayEmoji(Context context, Bitmap picture){
        ...
        if (faces.size() == 0) {
            Toast.makeText(context, "There is on faces ", Toast.LENGTH_SHORT).show();
        } else {
